...
export const APIS = [ActivitiesService, AthletesService, ClubsService, GearsService, RoutesService, SegmentEffortsService, SegmentsService, StreamsService, UploadsService];

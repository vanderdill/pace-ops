...
export class AthletesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getStats(id: number, observe?: 'body', reportProgress?: boolean): Observable<ActivityStats>;
    public getStats(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ActivityStats>>;
    public getStats(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ActivityStats>>;
    public getStats(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

...
export class ActivitiesService {
     ...
     */
    public createActivity(name: string, sportType: string, startDateLocal: Date, elapsedTime: number, type?: string, description?: string, distance?: number, trainer?: number, commute?: number, observe?: 'body', reportProgress?: boolean): Observable<DetailedActivity>;
    public createActivity(name: string, sportType: string, startDateLocal: Date, elapsedTime: number, type?: string, description?: string, distance?: number, trainer?: number, commute?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DetailedActivity>>;
    public createActivity(name: string, sportType: string, startDateLocal: Date, elapsedTime: number, type?: string, description?: string, distance?: number, trainer?: number, commute?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DetailedActivity>>;
    public createActivity(name: string, sportType: string, startDateLocal: Date, elapsedTime: number, type?: string, description?: string, distance?: number, trainer?: number, commute?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (sportType !== undefined) {
            formParams = formParams.append('sport_type', <any>sportType) || formParams;
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCommentsByActivityId(id: number, page?: number, perPage?: number, pageSize?: number, afterCursor?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Comment>>;
    public getCommentsByActivityId(id: number, page?: number, perPage?: number, pageSize?: number, afterCursor?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Comment>>>;
    public getCommentsByActivityId(id: number, page?: number, perPage?: number, pageSize?: number, afterCursor?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Comment>>>;
    public getCommentsByActivityId(id: number, page?: number, perPage?: number, pageSize?: number, afterCursor?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (afterCursor !== undefined && afterCursor !== null) {
            queryParameters = queryParameters.set('after_cursor', <any>afterCursor);
        }
